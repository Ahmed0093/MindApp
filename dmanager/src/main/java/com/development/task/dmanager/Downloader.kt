...
import com.development.task.dmanager.base.DownloadTask
import com.development.task.dmanager.base.OnDownloadListener
import com.development.task.dmanager.base.database.DownloaderDatabase
...
class Downloader private constructor(downloadTask: DownloadTask) : IDownload {
    ...
    private var mDownloadTask2: DownloadTask? = null
